...
import 'package:shofri/UI/widget/map_location_picker_product.dart';

class SearchLocationProduct extends StatefulWidget {
  @override
  _SearchLocationProductState createState() => _SearchLocationProductState();
}

class _SearchLocationProductState extends State<SearchLocationProduct> {
                  ...
                  onTap: () async {
                    ...
                    if (detail != null) {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => MapLocationPickerProduct(
